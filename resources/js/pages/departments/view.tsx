...
import { DepartmentViewModalProps } from './types';

export function DepartmentViewModal({ open, onOpenChange, department, onEdit }: DepartmentViewModalProps) {
    ...
    return (
        <Modal open={open} onOpenChange={onOpenChange}>
            <ModalContent className="sm:max-w-[800px]">
                <ModalHeader>
                    <ModalTitle>{t('Department Details')}</ModalTitle>
                </ModalHeader>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-900">
                                {department.description || t('No description provided')}
                            </p>
                        </div>
