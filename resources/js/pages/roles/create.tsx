...
import { RoleCreateModalProps, RoleFormData } from './types';

export function RoleCreateModal({ open, onOpenChange, permissions }: RoleCreateModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/roles', {
            ...
            onError: () => {
                toast.error(t('Failed to create role'), { description: t('Please check the form and try again') });
            },
        });
    };
        ...
        <Modal open={open} onOpenChange={handleClose}>
            <ModalContent className="sm:max-w-[800px]">
                <form onSubmit={handleSubmit}>
                    <ModalHeader>
                        <ModalTitle>{t('Create Role')}</ModalTitle>
                    </ModalHeader>
